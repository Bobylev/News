...
public class DetailActivity extends DaggerAppCompatActivity implements DetailContracts.View{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((SimpleDraweeView)findViewById(R.id.detail_view_img)).setImageURI(article.urlToImage);
        ...
        ((TextView)findViewById(R.id.detail_link)).setOnClickListener(new View.OnClickListener() {
            @Override
